...
public class SmithChartSettingsWindow implements ActionListener {
	...
	public SmithChartSettingsWindow(Controller controller, Figure fig) {
		...
		// pnlX.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)),
		// "X-Axis", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0,
		// 0, 0)));
		...
		dialog.setFocusTraversalPolicy(new FocusTraversalOnArray(
				new Component[] { dialog.getContentPane(), tfRefResistance, btnCancel, btnOk }));
	}

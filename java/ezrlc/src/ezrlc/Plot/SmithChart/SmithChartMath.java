...
public class SmithChartMath {
	 ...
	 * 
	 * @param center
	 *            centerpoint of the plot
	 * @param diameter
	 *            diameter of the smithchart
	 * @param norm
	 *            normalization value
	 */
	 ...
	 * 
	 * @param val
	 *            complex value to be normalized
	 * @param ref
	 *            reference value
	 * @return normalized value
	 */
	 ...
	 * 
	 * @param val
	 *            The (not normalized) value of the axis point
	 * @return Center point
	 */
	public PointD getRealGridCenterPoint(double val) {
		...
		double x_coordinate = ((diameter * (normalized + 1) / 2) + (center.x - (this.diameter / 2))); // stretch
																										// to
																										// display
																										// area

...
public class MCRank {
	...
	/**
	 * Sorts the incomming list of equivalent circuits by their error, and returns the n-best, best first
	 * @param yz measured Z data
	 * @param in list of circuit models
	 * @param n number of best circuits to return
	 * @return sorted models, best first
	 */

...
public class MathUtil {
	...
	/**
	 * Dumps a List of complex numbers into a file It can be read with matlab
	...
	/**
	 * Dumps a List of double numbers into a file It can be read with matlab
	 * using following code <code>
	...
	/**
	 * Converts a double number to the engineering notation Source:

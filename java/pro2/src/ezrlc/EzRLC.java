...
public class EzRLC {
	...
	public static void main(String[] args) {
		...
		// view.build();
		//
		//// controller.loadFile(new
		// File("/Users/noah/git/pro2/sample_files/bsp1.s1p"));
		// controller.loadFile(new File("E:\\proj2\\sample_files\\8.s1p"));
		//
		...
		// */
		// List<MCEqCircuit> circuits = new
		// ArrayList<MCEqCircuit>(circuitList.length);
		...
		//// new NelderMeadSimplex(new double[] { 0.001, 0.001, 0.001, 0.001,
		// 0.001, 0.001, 0.001 }));
		//
		//// System.out.println("Bauteilwerte: " +
		// Arrays.toString(optimum.getPoint()) + " Fehler: " +
		// optimum.getValue());
		...
		// double[] w = MathUtil.linspace(2.0*Math.PI*(1e6),
		// 2.0*Math.PI*(100e6), 100);
		// for (double d : w) {
		...
		// }
		// // Get Z Data
		// List<Double> z_imag = new
		// ArrayList<Double>(rfData.getzData().size());
		...
		// //fig.addDataSet(testset); // Testset 1, linear from x=0 to 99,
		// y=x/100
		...
		// Complex complextmp1;
		// Complex complextmp2 = new Complex(1.0,0); // constant 1 as complex
		// number
		// Complex complextmp3 = new Complex(50,0); // resistance as complex
		// number
		//
		// // Z=Ro*((1+S)/(1-S))
		// complextmp1 = new Complex(Complex.mul(complextmp3,
		// Complex.div(Complex.add(complextmp2, complex),
		// Complex.sub(complextmp2, complex))));
		// complextmp1.printRI();
		...
		//
		// System.out.println(a.sprintRI() +" * " +a.sprintRI() +" = "
		// +mul1.sprintRI());
		// System.out.println(a.sprintRI() +" * " +b.sprintRI() +" = "
		// +mul2.sprintRI());
		// System.out.println(a.sprintRI() +" * " +c.sprintRI() +" = "
		// +mul3.sprintRI());
		// System.out.println(a.sprintRI() +" * " +d.sprintRI() +" = "
		// +mul4.sprintRI());
		//

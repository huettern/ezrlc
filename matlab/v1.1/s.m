...
switch n
    ...
    case 19
        ...
        Pn=[0,c0*l*r0,l,r0];
    case 20
        Pz=[0,0,l*r0,(r1*(1+(w/w0 ).^alpha))*r0];
        Pn=[0,c0*l*r0,c0*r0*(r1*(1+(w/w0 ).^alpha))+l,(r1*(1+(w/w0 ).^alpha))+r0];
    case 21
        Pz=[0,l*c0,c0*(r0*(1+(w/w0 ).^alpha)),1];
...
s=(z-Rbez)./(z+Rbez);                      %s-parameter berechnen
end
